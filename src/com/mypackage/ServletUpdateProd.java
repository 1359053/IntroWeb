...
public class ServletUpdateProd extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String skuStr = request.getParameter("update_sku").trim();
        ...
        //System.out.println(skuStr + "----" + catStr + "----" + manStr + "----" + name + "----" + proc + "----" + ramStr + "----" + scrStr + "----" + hddStr + "----" + pic + "----1--" + priceStr);

        int sku = 0;
        if (skuStr.length() > 0 && Integer.parseInt(skuStr) > 0) {
